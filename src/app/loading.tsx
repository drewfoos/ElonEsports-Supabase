      ...
      <div className="relative z-10 border-b border-white/[0.06]">
        <div className="mx-auto grid max-w-5xl grid-cols-1 gap-4 px-4 py-5 sm:grid-cols-2 sm:py-4">
          <div className="flex flex-col gap-1.5">
            ...
            <div className="h-9 w-full animate-pulse rounded-md bg-white/[0.03] border border-white/[0.08] sm:w-52" />
          </div>
          <div className="flex flex-col gap-1.5">
          ...
          <div className="border-b border-white/[0.06] px-4 py-3">
            <div className="flex gap-8">
              {['w-8', 'w-24', 'w-20', 'w-16', 'w-20'].map((w, i) => (
                <div key={i} className={`h-4 ${w} animate-pulse rounded bg-white/[0.06]`} />
              ))}
            </div>
          </div>
